...
for i in ModelGeomPy.Elem.num_toElem.items():
    ...
    p1 = pyautocad.APoint(points1[0], points1[1], points1[2])
    p2 = pyautocad.APoint(points2[0], points2[1], points2[2])
    p3 = pyautocad.APoint(points3[0], points3[1], points3[2])
    p4 = pyautocad.APoint(points4[0], points4[1], points4[2])
